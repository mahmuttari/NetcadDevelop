...
function synDxf(extra = '') {
  ...
  s += L(0, 'HATCH') + L(5, 'H1') + L(8, '0') + L(100, 'AcDbHatch') + L(10, 0) + L(20, 0) + L(30, 0) + L(210, 0) + L(220, 0) + L(230, 1) + L(2, 'ANSI31') + L(70, 0) + L(71, 0) + L(91, 1)
    ...
    + L(75, 0) + L(76, 1) + L(52, 0) + L(41, 1) + L(77, 0) + L(78, 1) + L(53, 45) + L(43, 0) + L(44, 0) + L(45, 0) + L(46, 0.125) + L(79, 0)   // 45-46 ÇİZGİNİN kendi ekseninde: ANSI31'in dik aralığı 0,125 + L(47, 1) + L(98, 0);
...
await openFile(page, path.join(out, 'syn.dxf'), { settle: 300 });
{
  ...
  ok('5d2 desenli HATCH: desen ilkeli (hp) ile LOD dolgusu (hpFill) eşleşiyor', r.hp >= 1 && r.hp === r.hpFill, JSON.stringify({ hp: r.hp, hpFill: r.hpFill }));
