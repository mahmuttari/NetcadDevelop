...
// ---------------------------------------------------------------------------------
{
  ...
  ok('8 kilitli Çiz sekmesi satırı açar, paket panelini AÇMAZ; 18 karo rozetli, tek çağrı karosu BAŞTA',
    r.tab === 'draw' && !r.panel && r.tiles === 18 && r.locked === 18 && r.cta === 1 && r.ctaTier === 'premium' && r.first, JSON.stringify(r));
