...
// ---- 11. İngilizce etiketler ve komut tablosu notları ---------------------------------------------------------------
{
  ...
  ok('11b komut tablosu: beş komutun notu Ekran / Ölçü sorusunu söyler, LENGTHEN notu Ölçü kipine yönlendirir; sayılar değişmedi', [a.o, a.tr, a.ex, a.f, a.cha].every(n => /Screen or Measure/.test(n || '')) && /Measure mode/.test(a.len || '') && a.st.total === 506 && a.st.acad === 220 && a.st.names === 751, J(a));
}
