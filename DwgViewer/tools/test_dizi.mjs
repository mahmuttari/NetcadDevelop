...
// ---------------------------------------------------------------------------------
{
  ...
  ok('5a tablo sağlıklı; sayılar 487 kayıt · 180 AutoCAD · 31 özgü · 276 bulunmayan · 731 ad', g.hata.length === 0 && g.st.total === 487 && g.st.acad === 180 && g.st.ext === 31 && g.st.known === 276 && g.st.names === 731, J({ hata: g.hata, st: g.st }));
