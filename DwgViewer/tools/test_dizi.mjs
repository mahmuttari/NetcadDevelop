...
// ---------------------------------------------------------------------------------
{
  ...
  ok('5a tablo sağlıklı; sayılar 504 kayıt · 214 AutoCAD · 31 özgü · 259 bulunmayan · 748 ad', g.hata.length === 0 && g.st.total === 504 && g.st.acad === 214 && g.st.ext === 31 && g.st.known === 259 && g.st.names === 748, J({ hata: g.hata, st: g.st }));
