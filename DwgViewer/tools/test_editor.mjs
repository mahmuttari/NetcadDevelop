...
const n0 = await count(); ok('1 başlangıç ilkel sayısı 283', n0 === 283, String(n0));   // katı/ağ gövdeleri tek ağ ilkeli (k=5)
...
ok('2b iki çizgi eklendi (285)', await count() === n0 + 2, String(await count()));
