...
// ---------------------------------------------------------------------------------
{
  ...
  ok('4b LINE ve PLINE notları doğrudan uzaklık girişini söyler; sayılar sabit', /Direct distance/.test(a.l || '') && /Direct distance/.test(a.pl || '') && a.st.total === 487 && a.st.names === 731, J(a));
