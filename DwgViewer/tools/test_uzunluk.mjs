...
// ---------------------------------------------------------------------------------
{
  ...
  ok('4b LINE ve PLINE notları doğrudan uzaklık girişini söyler; sayılar sabit', /Direct distance/.test(a.l || '') && /Direct distance/.test(a.pl || '') && a.st.total === 508 && a.st.names === 755, J(a));
