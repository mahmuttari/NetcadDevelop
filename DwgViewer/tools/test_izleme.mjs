...
// ---------------------------------------------------------------------------------
{
  ...
  ok('10a OTRACK notu iz noktasını, TT düğmesini ve kesişimi söyler; komut sayıları sabit', /tracking point/.test(a.note || '') && /TT/.test(a.note || '') && /intersections/.test(a.note || '') && a.st.total === 504 && a.st.names === 748, J(a));
