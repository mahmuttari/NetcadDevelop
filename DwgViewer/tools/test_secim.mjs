...
}
{
  ...
  ok('13 rozete dokunmak seçim menüsünü açar: 12 kart', d.acik && /^Seçim · \d+ nesne$/.test(d.baslik) && kart === 'del,copy,move,block,rotate,mirror,scale,color,ltype,layer,props,clear', J({ d, kart }));
