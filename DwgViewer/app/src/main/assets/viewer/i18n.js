...
export const TR = {
  ...
  proTitle: 'DWG OfficeZip Pro', proFeaturesIntro: 'Pro tek seferlik satın alımdır; bütün özellikleri açar:', proFeatures: 'Çizim ve düzenleme araçları|3B düzenleme|Kot / eğim profili|Notlar (redline)|DXF kaydetme|Ölçekli PDF çıktısı|Revizyon karşılaştırma|Geri al / yinele|Drive\'a yükleme|Reklamsız',
...
export const EN = {
  ...
  proTitle: 'DWG OfficeZip Pro', proFeaturesIntro: 'Pro is a one-time purchase that unlocks everything:', proFeatures: 'Drawing and editing tools|3D editing|Elevation / slope profile|Notes (redline)|DXF saving|Scaled PDF export|Revision comparison|Undo / redo|Upload to Drive|No ads',
