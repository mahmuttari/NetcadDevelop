...
export const TR = {
  ...
  layer: 'Katman', color: 'Renk', ltype: 'Çizgi tipi', lweight: 'Kalınlık', length: 'Uzunluk', start: 'Başlangıç', end: 'Bitiş', vertices: 'Köşe sayısı', triCount: 'Üçgen',
...
export const EN = {
  ...
  layer: 'Layer', color: 'Color', ltype: 'Linetype', lweight: 'Lineweight', length: 'Length', start: 'Start', end: 'End', vertices: 'Vertices', triCount: 'Triangles',
