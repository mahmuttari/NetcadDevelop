...
export const COMMANDS = [
  ...
  T('RENAME', 'layers', ['REN'], 'Rename', { syn: true, noRepeat: true, note: 'layers are renamed in the layer manager (Edit layer); blocks and styles cannot be renamed' }),
  ...
  NA('3DARRAY', ['3A'], '3D array', 'ARRAY (rectangular / polar in the plan)'),
  NA('TEXTSCR', [], 'Text window', 'the ↑ / ↓ keys browse the command history'),
  NA('ATTIPEDIT', ['ATI'], 'Edit attribute in place', 'ATTEDIT'),
  ...
  NA('BCLOSE', ['BC'], 'Close block editor'),
  NA('BSAVE', ['BS'], 'Save block'),
