...
export const COMMANDS = [
  ...
  T('DXFOUT', 'savedxf', [], 'Save as DXF'),
  T('SAVEAS', 'saveas', [], 'Save as', { note: 'saves a DXF; DWG cannot be written' }),
  T('SAVE', 'save', ['QSAVE'], 'Save', { note: 'saves a DXF; DWG cannot be written' }),
