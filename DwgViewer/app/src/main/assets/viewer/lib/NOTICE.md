...
DWG OfficeZip aşağıdaki bileşenleri kullanır. Bu dosya yalnız kaynak
...
| pdf-lib (`pdf-lib.min.js`) | 1.17.1 | MIT | PDF düzenleme: açıklamaların ve sayfa işlemlerinin gerçek PDF'e yazılması (Pro) |
